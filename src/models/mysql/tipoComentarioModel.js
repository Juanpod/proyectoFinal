...
export class TipoComentario {
    ...
    static async getById(idTipoComentario) {
        const query =
            "SELECT idTipoComentario, tipoComentario FROM TiposComentarios WHERE idTipoComentario = ?;";
        let connection;
        ...
        try {
            ...
            console.error(
                "Error al obtener el tipo de comentario para el id",
                idTipoComentario
            );
    ...
    static async create(tipoComentario) {
        const query =
            "INSERT INTO TiposComentarios (tipoComentario) VALUES (?);";
        const searchQuery =
            "SELECT * FROM TiposComentarios WHERE tipoComentario = ?;";
        let connection;
    ...
    static async update(idTipoComentario, tipoComentario) {
        const query =
            "UPDATE TiposComentarios SET tipoComentario = ? WHERE idTipoComentario = ?;";
        const searchQuery =
            "SELECT * FROM TiposComentarios WHERE tipoComentario = ? AND idTipoComentario != ?;";
        let connection;
    ...
    static async delete(idTipoComentario) {
        const query =
            "DELETE FROM TiposComentarios WHERE idTipoComentario = ?;";
        let connection;
