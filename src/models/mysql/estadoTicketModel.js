...
export class EstadoTicket {
    ...
    static async getById(idEstadoTicket) {
        const query =
            "SELECT idEstadoTicket, estadoTicket FROM EstadosTickets WHERE idEstadoTicket = ?;";
        let connection;
        try {
            connection = await createConnection();
            ...
            console.error(
                "Error al obtener el estado para el id",
                idEstadoTicket
            );
    ...
    static async create(estadoTicket) {
        ...
        const searchQuery =
            "SELECT * FROM EstadosTickets WHERE estadoTicket = ?;";
        let connection;
    ...
    static async update(idEstadoTicket, estadoTicket) {
        const query =
            "UPDATE EstadosTickets SET estadoTicket = ? WHERE idEstadoTicket = ?;";
        const searchQuery =
            "SELECT * FROM EstadosTickets WHERE estadoTicket = ? AND idEstadoTicket != ?;";
        let connection;
